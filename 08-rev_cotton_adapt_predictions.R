...
pmod3 <- readRDS("models/modtwenty_cotton.rds")
pmod4 <- readRDS("models/modthirty_cotton.rds")
pmod5 <- readRDS("models/modsixty_cotton.rds")
...
head(adat)
saveRDS(adat, "data/rev_cotton_pred.rds")
...
saveRDS(pdat, "data/rev_cotton_predictions.rds")
...
ggsave("figures/predicted_cotton.pdf", device = "pdf", width = 6, height = 4)
