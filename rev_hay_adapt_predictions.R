...
# Load models
pmod1 <- readRDS("models/modfive_hay.rds")
pmod2 <- readRDS("models/modten_hay.rds")
pmod3 <- readRDS("models/modtwenty_hay.rds")
pmod4 <- readRDS("models/modthirty_hay.rds")
pmod5 <- readRDS("models/modsixty_hay.rds")
...
saveRDS(pdat, "data/rev_hay_predictions.rds")
