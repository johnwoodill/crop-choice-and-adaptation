...
# Total-effect predictions
total_terms = c("dday0_10", "dday10_30", "dday30", "prec", "prec_sq", "dday0_10_five", "dday10_30_five", "dday30_five", "prec_five", "prec_sq_five")
...
wfive <- predictSUR.clean(mod = sur_five, 
                          acres = cropdat$acres, 
                          newdata_list = newdata_list_five, 
                          var.terms = weather_terms, 
                          cons.terms = cons.terms_c_five, 
                          type = "5-year", 
                          effect = "Weather-effect")
cfive <- predictSUR.clean(mod = sur_five, acres = cropdat$acres,  newdata_list = newdata_list_five, var.terms = climate_terms, cons.terms = cons.terms_w, type = "5-year", effect = "Climate-effect")
tfive <- predictSUR.clean(mod = sur_five, acres = cropdat$acres,  newdata_list = newdata_list_five, var.terms = total_terms, cons.term  = NULL, type = "5-year", effect = "Total-effect")
...
# Total-effect predictions
total_terms = c("dday0_10", "dday10_30", "dday30", "prec", "prec_sq", "dday0_10_ten", "dday10_30_ten", "dday30_ten", "prec_ten", "prec_sq_ten")
...
tten <- predictSUR.clean(sur_ten, acres = cropdat$acres,  newdata_list = newdata_list_ten,  var.terms = total_terms, cons.term  = NULL, type = "10-year", effect = "Total-effect")
...
# Total-effect predictions
total_terms = c("dday0_10", "dday10_30", "dday30", "prec", "prec_sq", "dday0_10_twenty", "dday10_30_twenty", "dday30_twenty", "prec_twenty", "prec_sq_twenty")
...
ttwenty <- predictSUR.clean(sur_twenty, acres = cropdat$acres,  newdata_list = newdata_list_twenty, var.terms = total_terms, cons.term  = NULL, type = "20-year", effect = "Total-effect")
...
# Total-effect predictions
total_terms = c("dday0_10", "dday10_30", "dday30", "prec", "prec_sq", "dday0_10_thirty", "dday10_30_thirty", "dday30_thirty", "prec_thirty", "prec_sq_thirty")
...
tthirty <- predictSUR.clean(sur_thirty, acres = cropdat$acres,  newdata_list = newdata_list_thirty, var.terms = total_terms, cons.term  = NULL, type = "30-year", effect = "Total-effect")
...
csixty <- predictSUR.clean(sur_sixty, acres = cropdat$acres,  newdata_list = newdata_list_sixty, var.terms = climate_terms, cons.terms = NULL,  type = "60-year", effect = "Climate-effect")
