...
star1 <- star1[1:loc-1]
star1notes <- paste("\\parbox{6.8in}{Notes: Table reports regression coefficients for a seemingly unrelated regression (SUR) using transformed crop shares to z-scores for climate (rolling mean) degree days and precipitation variables from 1950-2010.
Z-scores are calculated using individual crop shares as a proportion of total acres. Climate effects use a right rolling mean windows from 10-year. 
