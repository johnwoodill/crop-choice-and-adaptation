...
# Load models
pmod1 <- readRDS("models/modfive_corn.rds")
pmod2 <- readRDS("models/modten_corn.rds")
pmod3 <- readRDS("models/modtwenty_corn.rds")
pmod4 <- readRDS("models/modthirty_corn.rds")
pmod5 <- readRDS("models/modsixty_corn.rds")
...
head(adat)
saveRDS(adat, "data/rev_corn_pred.rds")
...
saveRDS(pdat, "data/rev_corn_predictions.rds")
