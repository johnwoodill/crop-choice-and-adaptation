...
tfive <- predictSUR.clean(mod = sur_five, acres = cropdat$acres,  newdata_list = newdata_list_five, type = "5-year", effect = "Total-effect")
...
tten <- predictSUR.clean(sur_ten, acres = cropdat$acres,  newdata_list = newdata_list_ten, type = "10-year", effect = "Total-effect")
...
ttwenty <- predictSUR.clean(sur_twenty, acres = cropdat$acres,  newdata_list = newdata_list_twenty, type = "20-year", effect = "Total-effect")
...
tthirty <- predictSUR.clean(sur_thirty, acres = cropdat$acres,  newdata_list = newdata_list_thirty, type = "30-year", effect = "Total-effect")
