...
# Load models
pmod1 <- readRDS("models/modfive_soybean.rds")
pmod2 <- readRDS("models/modten_soybean.rds")
pmod3 <- readRDS("models/modtwenty_soybean.rds")
pmod4 <- readRDS("models/modthirty_soybean.rds")
pmod5 <- readRDS("models/modsixty_soybean.rds")
...
head(adat)
saveRDS(adat, "data/rev_soybean_pred.rds")
...
saveRDS(pdat, "data/rev_soybean_predictions.rds")
...
ggsave("figures/predicted_soybean.pdf", device = "pdf", width = 6, height = 4)
